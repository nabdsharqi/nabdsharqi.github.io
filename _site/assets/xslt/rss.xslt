...
<div id="masthead-no-image-header">
	<div class="row">
		<div class="small-12 columns">
			<a id="logo" href="http://nabd-sharqi.com" title="نبض شرقي – نبض شرقي">
				<!-- <img src="http://nabd-sharqi.com/assets/img/logo.png" alt="نبض شرقي – نبض شرقي"> -->
